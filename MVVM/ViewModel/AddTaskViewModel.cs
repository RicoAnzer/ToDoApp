...
/**
ViewModel Class for AddTaskWindow in Task-App
...
{
    public partial class AddTaskViewModel : ObservableObject, INotifyDataErrorInfo
    {
        ...
        public static AddTaskViewModel? Instance { get; private set; }
        ...
        public string TaskDesc => _localizationService.GetString("HeaderDescription");
        public string TaskPrio => _localizationService.GetString("HeaderPriority");
        public string TaskDate => _localizationService.GetString("HeaderDueDate");
        public string CancelTask => _localizationService.GetString("BtnCancelTask");
        public string SaveTask => _localizationService.GetString("BtnSaveTask");
        public string DescTaskxtError => _localizationService.GetString("DescErrorTaskxt");
        ...
        public AddTaskViewModel()
        {
            ...
            _localizationService = TaskListWindowViewModel._localizationService!;
        ...
        //Add new Task to DB after click on button
        [RelayCommand]
        private void AddTask()
        {
            ...
            //Otherwise, no Task added and error messages of TextBoxContent etc. will be displayed as defined at variables block
        ...
        private void OnErrorsChanged(object sender, DataErrorsChangedEventArgs e)
        {
            ...
            var errorService = sender as AddTaskViewModel;
        ...
        {
            //Clear past errors
            RemoveError(nameof(TextBoxContent), DescTaskxtError);
            ...
            {
                AddError(nameof(TextBoxContent), DescTaskxtError);
            }
